...
public class MessageUnpacker implements Closeable {
   ...
   private MessageBuffer getNextBuffer() throws IOException {
      ...
      if (next == null) {
         ...
         this.totalReadBytes = this.totalReadBytes + this.buffer.size();
         return next;
      }
   }
      ...
      switch (mf.getValueType()) {
         ...
         case STRING: {
            ...
            if (length > this.stringSizeLimit) {
               throw new MessageSizeException(String.format("cannot unpack a String of size larger than %,d: %,d", this.stringSizeLimit, length), length);
            }
      ...
      if (MessagePack.Code.isFixInt(b)) {
         ...
         switch (b) {
            ...
            case -50:
               int u32 = this.readInt();
               if (u32 < 0) {
                  return (u32 & 2147483647) + 2147483648L;
               }
   ...
   public BigInteger unpackBigInteger() throws IOException {
      ...
      if (MessagePack.Code.isFixInt(b)) {
         ...
         switch (b) {
            case -52:
               byte u8 = this.readByte();
               return BigInteger.valueOf(u8 & 255);
            case -51:
               short u16 = this.readShort();
               return BigInteger.valueOf(u16 & '\uffff');
            case -50:
               int u32 = this.readInt();
               if (u32 < 0) {
                  return BigInteger.valueOf((u32 & 2147483647) + 2147483648L);
               }
   ...
   public Instant unpackTimestamp(ExtensionTypeHeader ext) throws IOException {
      if (ext.getType() != -1) {
         ...
         switch (ext.getLength()) {
            case 4:
               long u32 = this.readInt() & 4294967295L;
            ...
            case 12: {
               long nsecU32 = this.readInt() & 4294967295L;
   ...
   public void close() throws IOException {
      this.totalReadBytes = this.totalReadBytes + this.position;
      this.buffer = EMPTY_BUFFER;
      this.position = 0;
      this.in.close();
   }
   ...
   private static MessageIntegerOverflowException overflowU8(byte u8) {
      BigInteger bi = BigInteger.valueOf(u8 & 255);
   ...
   private static MessageIntegerOverflowException overflowU32(int u32) {
      BigInteger bi = BigInteger.valueOf((u32 & 2147483647) + 2147483648L);
      return new MessageIntegerOverflowException(bi);
   }
   ...
   private static MessageSizeException overflowU32Size(int u32) {
      long lv = (u32 & 2147483647) + 2147483648L;
