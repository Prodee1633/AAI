...
public class Variable implements Value {
   ...
   private abstract class AbstractNumberValueAccessor extends Variable.AbstractValueAccessor implements NumberValue {
      ...
      @Override
      public byte toByte() {
         return Variable.this.type == Variable.Type.BIG_INTEGER ? ((BigInteger)Variable.this.objectValue).byteValue() : (byte)Variable.this.longValue;
      }

      @Override
      public short toShort() {
         return Variable.this.type == Variable.Type.BIG_INTEGER ? ((BigInteger)Variable.this.objectValue).shortValue() : (short)Variable.this.longValue;
      }
      ...
      public double toDouble() {
         if (Variable.this.type == Variable.Type.BIG_INTEGER) {
            ...
            return Variable.this.type == Variable.Type.DOUBLE ? Variable.this.doubleValue : Variable.this.longValue;
         }
      }
   }
