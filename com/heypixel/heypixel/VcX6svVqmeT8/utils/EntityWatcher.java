      ...
      if (e.getType() == EventType.PRE && mc.level != null) {
         ...
         for (AbstractClientPlayer player : new ArrayList<AbstractClientPlayer>(mc.level.players())) {
            if (player != mc.player) {
               ...
               if ((InventoryUtils.isEndCrystal(player.getMainHandItem()) || InventoryUtils.isEndCrystal(player.getOffhandItem())) && !playerTags.contains("End Crystal")) {
               ...
               if ((InventoryUtils.isKBStick(player.getMainHandItem()) || InventoryUtils.isKBStick(player.getOffhandItem())) && !playerTags.contains("KB Stick")) {
