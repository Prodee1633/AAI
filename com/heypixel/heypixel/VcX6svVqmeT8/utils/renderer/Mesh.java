package com.heypixel.heypixel.VcX6svVqmeT8.utils.renderer;
...
public class Mesh {
   ...
   public Mesh vec3(double x, double y, double z) {
      long p = this.verticesPointer + this.vertexComponentCount * 4L;
   ...
   public Mesh color(Color c) {
      long p = this.verticesPointer + this.vertexComponentCount * 4L;
      MemoryUtil.memPutFloat(p, c.getRed() / 255.0F);
      MemoryUtil.memPutFloat(p + 4L, c.getGreen() / 255.0F);
      MemoryUtil.memPutFloat(p + 8L, c.getBlue() / 255.0F);
      MemoryUtil.memPutFloat(p + 12L, c.getAlpha() / 255.0F * (float)this.alpha);
   ...
   public void line(int i1, int i2) {
      long p = this.indicesPointer + this.indicesCount * 4L;
   ...
   public void growIfNeeded() {
      if ((this.vertexI + 1) * this.primitiveVerticesSize >= this.vertices.capacity()) {
         ...
         MemoryUtil.memCopy(MemoryUtil.memAddress0(this.vertices), MemoryUtil.memAddress0(newVertices), this.vertexComponentCount * 4L);
      ...
      if (this.indicesCount * 4 >= this.indices.capacity()) {
         ...
         MemoryUtil.memCopy(MemoryUtil.memAddress0(this.indices), MemoryUtil.memAddress0(newIndices), this.indicesCount * 4L);
