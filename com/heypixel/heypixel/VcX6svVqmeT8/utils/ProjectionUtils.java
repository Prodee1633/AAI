...
import org.ywzj.doganticheat.mixin.accessors.GameRendererAccessor;
...
public class ProjectionUtils {
   ...
   private static Vector2f calculateScreenPosition(Vector3f result3f, double fov) {
      ...
      return result3f.z() < 0.0F
         ? new Vector2f(-result3f.x() * scaleFactor + mc.getWindow().getGuiScaledWidth() / 2.0F, mc.getWindow().getGuiScaledHeight() / 2.0F - result3f.y() * scaleFactor)
