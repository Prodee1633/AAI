   ...
   public void onRender(EventRender2D e) {
      ...
      for (Entry<MobEffect, EffectDisplay.MobEffectInfo> entry : this.infos.entrySet()) {
         ...
         if (effectInfo.yTimer.value == -1.0F) {
            effectInfo.yTimer.value = startY;
         }
         ...
         if (effectInfo.shouldDisappear) {
            ...
            effectInfo.durationTimer.target = (float)effectInfo.duration / effectInfo.maxDuration * effectInfo.width;
            ...
            effectInfo.yTimer.target = startY;
         ...
         harmony.render(e.getStack(), text, x + 27.0F, y + 7.0F, this.headerColor, true, 0.3);
         String duration = StringUtil.formatTickDuration(effectInfo.duration);
         harmony.render(e.getStack(), duration, x + 27.0F, y + 17.0F, Color.WHITE, true, 0.25);
