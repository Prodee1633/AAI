...
public class ItemTags extends Module {
   ...
   private void updatePositions(float renderPartialTicks) {
      ...
      for (Entity entity : mc.level.entitiesForRendering()) {
         if (entity instanceof ItemEntity itemEntity && this.isValidItem(itemEntity.getItem())) {
      ...
      try {
         ...
         for (ItemEntity ent : this.entityPositions.keySet()) {
            if (ent != null) {
               ...
               harmony.render(
                  stack, str, renderPositions.x - allWidth / 2.0F + 4.0F, renderPositions.y - 12.0F, Color.WHITE, true, this.scale.getCurrentValue()
               );
               stack.popPose();
            }
         }
