...
import com.heypixel.heypixel.VcX6svVqmeT8.modules.impl.render.projectiles.ProjectileData;
import com.heypixel.heypixel.VcX6svVqmeT8.modules.impl.render.projectiles.datas.BasicProjectileData;
import com.heypixel.heypixel.VcX6svVqmeT8.modules.impl.render.projectiles.datas.EntityArrowData;
...
import com.heypixel.heypixel.VcX6svVqmeT8.utils.RayTraceUtils;
...
public class Blink extends Module {
   ...
   public void onRender(EventRender2D e) {
      ...
      RenderUtils.drawRoundedRect(e.getStack(), x, y, 100.0F, 5.0F, 2.0F, Integer.MIN_VALUE);
      RenderUtils.drawRoundedRect(e.getStack(), x, y, this.progress.value, 5.0F, 2.0F, mainColor);
   }
   ...
   private boolean isTNTNear(double distance) {
      ...
      long tnt = stream.filter(entity -> entity instanceof PrimedTnt && this.fakePlayer.distanceTo(entity) <= distance).count();
      return tnt > 0L;
   }
   ...
   public void onMotion(EventMotion e) {
      if (e.getType() == EventType.PRE && mc.player != null) {
         ...
         while (this.releasedTicks < this.releaseSpeed.getCurrentValue() && this.shouldReleaseTicks > 0 && !this.packets.isEmpty()) {
            this.releaseTick();
            this.shouldReleaseTicks--;
         }

         while (this.releasedTicks < this.releaseSpeed.getCurrentValue() && this.isPlayerInDanger() && !this.packets.isEmpty()) {
            this.releaseTick();
         }

         while (
            this.releasedTicks < this.releaseSpeed.getCurrentValue()
         ...
         if (this.disabling) {
            while (this.releasedTicks < this.releaseSpeed.getCurrentValue() && !this.packets.isEmpty()) {
               this.releaseTick();
            }
