...
import com.heypixel.heypixel.VcX6svVqmeT8.annotations.FlowExclude;
import com.heypixel.heypixel.VcX6svVqmeT8.annotations.ParameterObfuscationExclude;
...
import com.heypixel.heypixel.VcX6svVqmeT8.events.impl.EventUpdateHeldItem;
...
import com.heypixel.heypixel.VcX6svVqmeT8.utils.MathHelper;
import com.heypixel.heypixel.VcX6svVqmeT8.utils.MoveUtils;
import com.heypixel.heypixel.VcX6svVqmeT8.utils.PlayerUtils;
...
public class Scaffold extends Module {
   ...
   private static Vec3 getVec3(BlockPos checkPosition, BlockState block) {
      ...
      double ex = MathHelper.clamp(mc.player.getX(), (double)checkPosition.getX(), checkPosition.getX() + shape.max(Axis.X));
      double ey = MathHelper.clamp(mc.player.getY(), (double)checkPosition.getY(), checkPosition.getY() + shape.max(Axis.Y));
      double ez = MathHelper.clamp(mc.player.getZ(), (double)checkPosition.getZ(), checkPosition.getZ() + shape.max(Axis.Z));
   ...
   public void onFoV(EventUpdateFoV e) {
      if (this.keepFoV.getCurrentValue() && MoveUtils.isMoving()) {
         e.setFov(this.fov.getCurrentValue() + PlayerUtils.getMoveSpeedEffectAmplifier() * 0.13F);
      }
   }
