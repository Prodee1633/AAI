...
import com.heypixel.heypixel.VcX6svVqmeT8.utils.PacketUtils;
         ...
         if (packet.getType() == EntityType.END_CRYSTAL) {
            ...
            if (mc.player.distanceTo(pTarget) <= 4.0F) {
               ...
               mc.getConnection()
                  .send(
                     new PosRot(
                        mc.player.getX(), mc.player.getY(), mc.player.getZ(), rotations.getX(), rotations.getY(), mc.player.onGround()
                     )
                  );
