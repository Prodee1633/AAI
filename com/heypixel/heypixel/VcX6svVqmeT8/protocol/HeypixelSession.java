...
import com.heypixel.heypixel.VcX6svVqmeT8.protocol.spoofer.FakeBaseboard;
import com.heypixel.heypixel.VcX6svVqmeT8.protocol.spoofer.FakeDiskStore;
import com.heypixel.heypixel.VcX6svVqmeT8.protocol.spoofer.FakeMac;
import java.io.File;
...
public class HeypixelSession {
   ...
   private final Random random = new Random(Minecraft.getInstance().getUser().getName().trim().hashCode());
