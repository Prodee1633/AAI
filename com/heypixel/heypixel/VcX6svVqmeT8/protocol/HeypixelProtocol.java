...
public class HeypixelProtocol {
   public static final String CHANNEL_CHECK_NAME = "heypixel:s2cevent";
   ...
   public static void sendScanClass1(ResourceLocation channelName, long runtime, String uuid1, String uuid2, int maxKlzSize) throws IOException {
      MessageBufferPacker bufferPacker = getDeafultMessagePack(runtime);
   ...
   public static void sendSession(ResourceLocation channelName, long runtime, long runtime1, String uuid1, String uuid2, Value gameSession) throws IOException {
      ...
      bufferPacker.packValue(
         new Variable()
            .setStringValue(
               "[minecraft, saturn, entityculling, mixinextras, netease_official, fastload, geckolib, waveycapes, ferritecore, embeddium_extra, heypixel, cloth_config, forge, embeddium, rubidium, oculus]"
            )
      );
   ...
   public static void method1403(ByteBuf byteBuf, int n) {
      method1404(byteBuf, n & 4294967295L);
   }
